          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col justify-start items-start w-full">
              ...
              <input
                id="username"
                type="email"
                className="border rounded-lg border-b-1 bg-white  naxatw-border-gray-300   w-[20rem] py-2 px-1  focus:!outline focus:outline-1 focus:outline-gray-500 outline-gray-400 "
              />
            </div>
            <div className="flex flex-col justify-start items-start w-full relative ">
              ...
              <input
                ...
                className="border  rounded-lg border-b-1 bg-white naxatw-border-gray-300 p-1 py-2 w-[20rem] focus:!outline focus:outline-1 focus:outline-gray-500 outline-gray-300"
              />
              <i
            ...
            <div className="button-section  gap-6  flex flex-col w-[20rem] py-6">
              <button
                type="submit"
